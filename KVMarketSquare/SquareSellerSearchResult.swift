...
// To parse the JSON, add this file to your project and do:
//
//   let squareMapSellerSearchResult = try? newJSONDecoder().decode(SquareMapSellerSearchResult.self, from: jsonData)

import Foundation

// MARK: - SquareMapSellerSearchResult
struct SquareMapSellerSearchResult: Codable {
    let data: [Datum]
    let meta: Meta
}
